...
export const PricingProfitSection = () => (
    <section className="bg-[#0a0a0a] py-24 px-4">
        <div className="max-w-5xl mx-auto">
            <div className="mb-24">
                <h2 className="text-4xl font-bold mb-6 text-center text-white">Como funciona a precificação?</h2>
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                    <div className="bg-[#1a1a1a] text-white p-8 w-64 text-center rounded-xl border border-zinc-800">
                        <div className="text-3xl font-bold mb-2">R$ 11,00</div>
                        <div className="text-sm text-zinc-500">Supermercado</div>
                    </div>
                    <ArrowRight className="w-10 h-10 text-[#FF6B00] hidden md:block" />
                    <div className="bg-[#FF6B00] text-white p-8 w-64 text-center rounded-xl shadow-lg shadow-[#FF6B00]/20 transform md:scale-110">
            ...
            <div>
                <h2 className="text-4xl font-bold mb-16 text-center text-white">E quanto consigo ter de lucro?</h2>

                <div className="flex flex-wrap justify-center items-center gap-2 md:gap-4 mb-12">
                    <div className="bg-[#FF6B00] text-white w-24 h-24 md:w-32 md:h-32 flex flex-col items-center justify-center text-center p-2 rounded-lg">
                ...
                <div className="flex flex-col items-center justify-center">
                    <div className="text-4xl text-[#FF6B00] font-bold mb-4">=</div>
                    <div className="border-4 border-[#FF6B00] bg-[#1a1a1a] text-white px-8 py-6 rounded-xl text-center shadow-xl shadow-[#FF6B00]/10">
                        <span className="text-4xl md:text-5xl font-black text-[#FF6B00]">20%</span>
